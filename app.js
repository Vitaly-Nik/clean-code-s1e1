...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="list__input chexbox-input input";

    listItem.className="list__item"
    deleteButtonImg.className="list__img img-remove"

    editInput.type="text";
    editInput.className="list__input text-input input";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="list__button button edit-button";

    deleteButton.className="list__button button delete-button";
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".chexbox-input");
